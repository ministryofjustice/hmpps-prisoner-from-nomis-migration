...
class OrganisationsConfiguration(
  ...
  @Bean
  fun organisationsApiHealthWebClient(builder: WebClient.Builder): WebClient = builder.reactiveHealthWebClient(apiBaseUri, healthTimeout)

  @Component("organisationsApi")
  class OrganisationsApiHealth(@Qualifier("organisationsApiHealthWebClient") webClient: WebClient) : ReactiveHealthPingCheck(webClient)
}
