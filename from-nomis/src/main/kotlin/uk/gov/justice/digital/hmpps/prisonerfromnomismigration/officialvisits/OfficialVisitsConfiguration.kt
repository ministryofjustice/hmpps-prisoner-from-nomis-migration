...
class OfficialVisitsConfiguration(
  ...
  ): WebClient = builder.reactiveAuthorisedWebClient(authorizedClientManager, registrationId = "officialvisits-api", url = apiBaseUri, timeout)

  @Component("officialVisitsApi")
  class OfficialVisitsApiHealth(@Qualifier("officialVisitsApiHealthWebClient") webClient: WebClient) : ReactiveHealthPingCheck(webClient)
}
