...
dependencies {
  ...
  implementation(project(":casenotes"))
  implementation(project(":core-person"))
  implementation(project(":court-sentencing"))
  implementation(project(":csra"))
  implementation(project(":finance"))
  implementation(project(":locations"))
  implementation(project(":movements"))
  implementation(project(":official-visits"))
  implementation(project(":organisations"))
  implementation(project(":personal-relationships"))
  implementation(project(":sentencing-adjustments"))
  implementation(project(":visit-balance"))
