...
val models = listOf(
  ...
  ModelConfiguration(
    ...
    // models = "Address,AddressId,CreateResponse,Email,EmailId,Identifier,Names,PhoneId,PhoneNumber,Prisoner,PrisonSexualOrientation,PrisonSexualOrientationResponseReligion",
  ),
  ModelConfiguration(
