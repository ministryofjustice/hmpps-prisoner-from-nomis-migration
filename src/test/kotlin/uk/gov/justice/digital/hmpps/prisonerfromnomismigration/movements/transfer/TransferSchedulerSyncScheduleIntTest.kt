...
class TransferSchedulerSyncScheduleIntTest(
  ...
  companion object {
    @JvmStatic
    fun scheduleUpdatedEvents() = listOf(
    ...
    inner class HappyPath {
      ...
      fun `should create DPS scheduled movement`() {
        TransferScheduleDpsApiMockServer.getRequestBody<SyncTransferRequest>(
          ...
          assertThat(transfer.schedule!!.start).isCloseTo(
  ...
  @ParameterizedClass
  @MethodSource("uk.gov.justice.digital.hmpps.prisonerfromnomismigration.movements.transfer.TransferSchedulerSyncScheduleIntTest#scheduleUpdatedEvents")
  @TestInstance(TestInstance.Lifecycle.PER_CLASS)
  inner class TransferScheduleOrWaitlistUpdated {

    @Parameter lateinit var eventType: String
    ...
    inner class HappyPath {
      ...
      fun setUp() {
        ...
        when (eventType) {
          "SCHEDULED_EXT_MOVE-UPDATED" -> sendMessage(transferScheduleEvent(eventType))
          else -> sendMessage(transferWaitlistEvent(eventType))
        }
          .also { waitForAnyProcessingToComplete() }
      }
    ...
    inner class WhenUpdatedInDps {
      ...
      fun setUp() {
        ...
        when (eventType) {
          "SCHEDULED_EXT_MOVE-UPDATED" -> sendMessage(transferScheduleEvent(eventType, "DPS_SYNCHRONISATION"))
          else -> sendMessage(transferWaitlistEvent(eventType, "DPS_SYNCHRONISATION"))
        }
          .also { waitForAnyProcessingToComplete() }
      }
  ...
  private fun transferWaitlistEvent(eventType: String, auditModuleName: String = "OIDSTWJU", eventId: Long = 123) = // language=JSON
    """{
         "Type" : "Notification",
         "MessageId" : "57126174-e2d7-518f-914e-0056a63363b0",
         "TopicArn" : "arn:aws:sns:eu-west-2:754256621582:cloud-platform-Digital-Prison-Services-f221e27fcfcf78f6ab4f4c3cc165eee7",
         "Message" : "{\"eventType\":\"$eventType\",\"eventDatetime\":\"2025-09-02T09:19:03\",\"nomisEventType\":\"$eventType\",\"bookingId\":12345,\"offenderIdDisplay\":\"A1234BC\",\"eventId\":$eventId,\"auditModuleName\":\"$auditModuleName\"}",
         "Timestamp" : "2025-09-02T09:19:03.998Z",
         "SignatureVersion" : "1",
         "Signature" : "",
         "SigningCertURL" : "https://sns.eu-west-2.amazonaws.com/SimpleNotificationService-6209c161c6221fdf56ec1eb5c821d112.pem",
