...
class ExternalMovementsNomisApiServiceTest {
  ...
  inner class GetTemporaryAbsences {
    ...
    fun `will return temporary absences`() = runTest {
      ...
      assertThat(result.bookings[0].temporaryAbsenceApplications[0].scheduledTemporaryAbsence?.eventId).isEqualTo(1)
      assertThat(result.bookings[0].temporaryAbsenceApplications[0].scheduledTemporaryAbsenceReturn?.eventId).isEqualTo(2)
      assertThat(result.bookings[0].temporaryAbsenceApplications[0].temporaryAbsence?.sequence).isEqualTo(3)
      assertThat(result.bookings[0].temporaryAbsenceApplications[0].temporaryAbsenceReturn?.sequence).isEqualTo(4)
