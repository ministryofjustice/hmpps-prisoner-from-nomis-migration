  ...
  inner class GetStaffDetailById {
    ...
    fun `will return staff details`() = runTest {
      ...
      with(staff) {
        ...
        assertThat(emailAddresses[0].emailAddressId).isEqualTo(3456)
        assertThat(emailAddresses[0].email).isEqualTo("john.smith@justice.gov.uk")
        assertThat(emailAddresses[0].audit.createDatetime).isEqualTo(LocalDateTime.parse("2016-08-01T10:55"))
        assertThat(emailAddresses[0].audit.createUsername).isEqualTo("KOFEADDY")
        assertThat(emailAddresses[0].audit.modifyDatetime).isEqualTo(LocalDateTime.parse("2017-08-01T10:55"))
        assertThat(emailAddresses[0].audit.modifyUserId).isEqualTo("KOFE_MOD")
