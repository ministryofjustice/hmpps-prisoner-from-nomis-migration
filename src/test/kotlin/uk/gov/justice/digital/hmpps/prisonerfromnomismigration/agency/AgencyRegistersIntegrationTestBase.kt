...
abstract class AgencyRegistersIntegrationTestBase : SqsIntegrationTestBase() {
  ...
  internal val agencyRegistersOffenderEventsQueue by lazy {
    hmppsQueueService.findByQueueId(
      AGENCY_REGISTERS_SYNC_QUEUE_ID,
    ) as HmppsQueue
  }

  override fun getQueues() = listOf(agencyRegistersMigrationQueue, agencyRegistersOffenderEventsQueue)
}
