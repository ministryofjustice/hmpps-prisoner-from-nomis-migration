...
class CorePersonSynchronisationBeliefsIntTest(
  ...
  private fun beliefsEvent(
  ...
  ) = """
   {
      ...
      "Message" : "{\"eventType\":\"OFFENDER_BELIEFS-$eventType\",\"eventDatetime\":\"2024-06-11T16:30:59\",\"offenderIdDisplay\":\"$prisonerNumber\",\"bookingId\":12345,\"rootOffenderId\":123,\"offenderBeliefId\":$beliefId,\"auditModuleName\":\"OIDBELIF\"}",
  ...
  private fun sendBeliefsEvent(
    ...
    beliefsEvent(prisonerNumber, beliefId, eventType),
  )
}
