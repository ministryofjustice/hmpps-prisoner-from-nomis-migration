...
class OfficialVisitsMigrationServiceTest {
  ...
  inner class ToMigrateVisitRequest {
    ...
    fun bindings(): Stream<Arguments> = Stream.of(
      ...
      Arguments.of(CodeDescription(code = "EXP", description = "Expired"), null, VisitCompletionType.NORMAL),
      ...
      Arguments.of(CodeDescription(code = "NORM", description = "Normal Completion"), null, VisitCompletionType.NORMAL),
