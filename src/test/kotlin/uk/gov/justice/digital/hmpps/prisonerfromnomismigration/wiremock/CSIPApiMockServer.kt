...
import uk.gov.justice.digital.hmpps.prisonerfromnomismigration.csip.CSIPMigrateResponse
...
class CSIPApiMockServer : WireMockServer(WIREMOCK_PORT) {
  ...
  fun stubCSIPMigration(dpsCSIPId: String = "a1b2c3d4-e5f6-1234-5678-90a1b2c3d4e5") {
    stubFor(
