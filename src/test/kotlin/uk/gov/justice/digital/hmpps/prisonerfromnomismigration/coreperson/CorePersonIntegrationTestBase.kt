...
abstract class CorePersonIntegrationTestBase : SqsIntegrationTestBase() {
  ...
  internal val corePersonMigrationQueue by lazy { hmppsQueueService.findByQueueId(CORE_PERSON_QUEUE_ID) as HmppsQueue }
  ...
  override fun getQueues(): List<HmppsQueue> = listOf(corePersonOffenderEventsQueue, corePersonMigrationQueue)
}
