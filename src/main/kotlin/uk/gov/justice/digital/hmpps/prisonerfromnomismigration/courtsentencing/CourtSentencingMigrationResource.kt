...
class CourtSentencingMigrationResource(
  ...
  suspend fun getAll(
    ...
    HistoryFilter(
      migrationTypes = listOf(MigrationType.COURT_SENTENCING.name),
  ...
  suspend fun getActiveMigrationDetails() = migrationHistoryService.getActiveMigrationDetails(MigrationType.COURT_SENTENCING)
}
