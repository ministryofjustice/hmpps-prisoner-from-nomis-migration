...
class CSIPMigrationMessageListener(
...
) : MigrationMessageListener<CSIPMigrationFilter, CSIPIdResponse, CSIPResponse, CSIPMappingDto>(
  objectMapper,
  ...
  override fun parseContextMapping(json: String): MigrationMessage<*, CSIPMappingDto> {
    return objectMapper.readValue(json)
  }
}
