...
enum class MigrationType(val queueId: String, val telemetryName: String) {
  ...
  CORE_PERSON_ALIAS_IDENTIFIER(CORE_PERSON_QUEUE_ID, "coreperson-alias-identifier"),
...
enum class SynchronisationType(val queueId: String) {
  ...
  CORE_PERSON(CORE_PERSON_SYNC_QUEUE_ID),
  ...
  TRANSFER_SCHEDULER(TRANSFERCHEDULER_SYNC_QUEUE_ID),
