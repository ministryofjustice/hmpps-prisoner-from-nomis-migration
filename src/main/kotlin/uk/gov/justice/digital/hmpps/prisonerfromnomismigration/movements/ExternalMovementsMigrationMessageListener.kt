...
) : MigrationMessageListener<ExternalMovementsMigrationFilter, PrisonerId, OffenderTemporaryAbsencesResponse, TemporaryAbsencesPrisonerMappingDto, ByPageNumber>(
  objectMapper,
  migrationService,
) {
