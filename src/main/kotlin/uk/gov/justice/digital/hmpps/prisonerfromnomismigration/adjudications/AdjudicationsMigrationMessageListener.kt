...
class AdjudicationsMigrationMessageListener(
  ...
  override fun parseContextFilter(json: String): MigrationMessage<*, AdjudicationsMigrationFilter> {
    return objectMapper.readValue(json)
  }

  override fun parseContextPageFilter(json: String): MigrationMessage<*, MigrationPage<AdjudicationsMigrationFilter>> {
    return objectMapper.readValue(json)
  }
