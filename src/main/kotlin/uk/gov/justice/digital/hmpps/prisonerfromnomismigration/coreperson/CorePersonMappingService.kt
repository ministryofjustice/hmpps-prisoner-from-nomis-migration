...
@Service
class CorePersonMappingService(@Qualifier("mappingApiWebClient") webClient: WebClient) : MigrationMapping<ReligionsMigrationMappingDto>("/mapping/core-person-religion", webClient) {
