...
@Configuration
class TransferScheduleConfiguration(
  ...
  @Bean
  fun transferScheduleDpsApiWebClient(
  ...
  @Bean
  fun transferSchedulerApiHealthWebClient(builder: WebClient.Builder): WebClient = builder.reactiveHealthWebClient(transferSchedulerUrl, healthTimeout)

  @Component("transferSchedulerApi")
  class TransferSchedulerApiHealth(@Qualifier("transferSchedulerApiHealthWebClient") webClient: WebClient) : ReactiveHealthPingCheck(webClient)
}
