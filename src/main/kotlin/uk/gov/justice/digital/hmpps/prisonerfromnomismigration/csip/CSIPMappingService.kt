...
@Service
class CSIPMappingService(@Qualifier("mappingApiWebClient") webClient: WebClient) : MigrationMapping<CSIPFullMappingDto>(domainUrl = "/mapping/csip", webClient) {

  override fun createMappingUrl(): String = super.createMappingUrl() + "/all"
  ...
  ): CreateMappingResult<CSIPFullMappingDto> = webClient.post()
  ...
  suspend fun getCSIPReportByNomisId(nomisCSIPReportId: Long): CSIPReportMappingDto? = webClient.get()
    .uri("/mapping/csip/nomis-csip-id/{nomisCSIPReportId}", nomisCSIPReportId)
    .retrieve()
    .awaitBodyOrNullWhenNotFound()

  suspend fun getDpsCsipMappings(nomisCSIPReportIds: List<Long>): List<CSIPReportMappingDto> = webClient.get().uri {
  ...
  suspend fun getFullMappingByDPSReportId(dpsCSIPReportId: String): CSIPFullMappingDto? = webClient.get()
  ...
  suspend fun getCSIPFactorByNomisId(nomisCSIPFactorId: Long): CSIPChildMappingDto? = webClient.get()
    .uri("/mapping/csip/factors/nomis-csip-factor-id/{nomisCSIPFactorId}", nomisCSIPFactorId)
    .retrieve()
    .awaitBodyOrNullWhenNotFound()

  suspend fun getCSIPPlanByNomisId(nomisCSIPPlanId: Long): CSIPChildMappingDto? = webClient.get()
  ...
  ): CreateMappingResult<CSIPChildMappingDto> = webClient.post()
  ...
  suspend fun getCSIPReviewByNomisId(nomisCSIPReviewId: Long): CSIPChildMappingDto? = webClient.get()
  ...
  suspend fun getCSIPAttendeeByNomisId(nomisCSIPAttendeeId: Long): CSIPChildMappingDto? = webClient.get()
  ...
  suspend fun getCSIPInterviewByNomisId(nomisCSIPInterviewId: Long): CSIPChildMappingDto? = webClient.get()
