...
) : MigrationMessageListener<OfficialVisitsMigrationFilter, VisitIdResponse, OfficialVisitResponse, OfficialVisitMigrationMappingDto, ByLastId<VisitIdResponse>>(
  objectMapper,
  migrationService,
) {
