...
class IncidentsMigrationResource(
  ...
  suspend fun getAll(
    ...
    HistoryFilter(
      migrationTypes = listOf(MigrationType.INCIDENTS.name),
  ...
  suspend fun cancel(
    ...
    @Schema(description = "Migration Id", example = "2020-03-24T12:00:00")
    migrationId: String,
  ) = incidentsMigrationService.cancel(migrationId)
  ...
  suspend fun getActiveMigrationDetails() = migrationHistoryService.getActiveMigrationDetails(MigrationType.INCIDENTS)
}
