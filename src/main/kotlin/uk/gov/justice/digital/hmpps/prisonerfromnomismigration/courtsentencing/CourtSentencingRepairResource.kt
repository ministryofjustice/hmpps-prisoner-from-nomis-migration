...
class CourtSentencingRepairResource(
  ...
  @Operation(
    ...
    description = "Used cases in DPS have become out of sync with NOMIS and NOMIS is the source of truth, so emergency use only. This is equivalent to migrating cases again for a specific prisoner. Requires ROLE_MIGRATE_SENTENCING",
  )
