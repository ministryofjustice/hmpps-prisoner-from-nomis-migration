...
export _JAVA_OPTIONS="-Xmx1024m -XX:ParallelGCThreads=2 -XX:ConcGCThreads=2 -XX:ParallelGCThreads=2 -Djava.util.concurrent.ForkJoinPool.common.parallelism=2 -Dorg.gradle.daemon=false -Dorg.gradle.jvmargs=-Dkotlin.compiler.execution.strategy=in-process -Dorg.gradle.workers.max=1"
